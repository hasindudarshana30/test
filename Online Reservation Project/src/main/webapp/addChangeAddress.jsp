...
%>
	<form action="addChangeAddressAction.jsp" method="post">
		...
		<input class="input-style" type="text" name="address"
			value="<%=rs.getString(5)%>" placeholder="Enter Address" required>
		<hr>
		<h3>Enter city</h3>
		<input class="input-style" type="text" name="city"
			value="<%=rs.getString(10)%>" placeholder="Enter City" required>
		<hr>
		<h3>Enter State</h3>
		<input class="input-style" type="text" name="state"
			value="<%=rs.getString(11)%>" placeholder="Enter State" required>
		<hr>
		<h3>Enter country</h3>
		<input class="input-style" type="text" name="country"
			value="<%=rs.getString(12)%>" placeholder="Enter Country" required>
		<hr>
