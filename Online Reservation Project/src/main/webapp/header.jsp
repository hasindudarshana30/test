...
<div class="topnav sticky">
	...
	<a href="home.jsp">Home<i class="fa fa-institution"></i></a> <a
		href="myCart.jsp">My Bill<i class='fas fa-cart-arrow-down'></i></a> <a
		href="myOrders.jsp">My Booking <i class='fab fa-elementor'></i></a> <a
	...
	<a href="about.jsp">Help <i class="fa fa-address-book"></i></a> <a
